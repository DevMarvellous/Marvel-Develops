  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-navy-deep px-6">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8">
        <h1 className="mb-1 font-display text-xl font-bold text-text-dark">Outends Admin</h1>
        <p className="mb-6 font-sans text-sm text-text-mid">Sign in to view submissions.</p>
